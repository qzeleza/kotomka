...
1. Быстрое развертывание среды разработки для роутеров Keenetic в Entware - от 30 минут.
...
3. Пока нет возможности переключать сборку для различных архитектур, сейчас авто-сборка только для архитектуры **mipsel**. Переключение на другую архитектуру требует установки параметра **PKGARCH** в нужное значение в файле манифеста **Makefile** в папке **compile**. 
